...
Test `scrape_show_info` on the first few URLs (e.g., `imdb_tv_urls[1]` is the *first* URL).



Now we will scrap the show information for every page for the top 100 TV shows.
We could do this by typing `scrap_show_info(imdb_tv_urls[i])` for each of the 100 shows, but this would be extremely inefficient and we would probably accidentally scrape some TV shows multiple times while skipping others.
